...
//!
//! The administrative pipe server lives in the `server` child module: the
//! fixed admin pipe instance, creation with the local-only owner/SID ACL mode,
//! accept and peer authentication, bounded frame I/O, the outbound-drain
//! proof and cancel/disconnect of the exact server handle.  This file keeps
//! the Win32 primitives plus the client and protected-path code and re-exports
//! the server entrypoints so every existing import path keeps working.
...
use windows_sys::Win32::Foundation::{
    ...
    ERROR_OPERATION_ABORTED, ERROR_PIPE_LISTENING, ERROR_PIPE_NOT_CONNECTED, ERROR_SEM_TIMEOUT,
...
use windows_sys::Win32::Storage::FileSystem::{
    ...
    GetFileInformationByHandle, OPEN_EXISTING, READ_CONTROL, ReadFile, WriteFile,
};
use windows_sys::Win32::System::IO::CancelIoEx;
use windows_sys::Win32::System::Pipes::{
    GetNamedPipeServerProcessId, PIPE_NOWAIT, PIPE_READMODE_MESSAGE, SetNamedPipeHandleState,
};
